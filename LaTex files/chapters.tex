...
\begin{figure}[b]
	\centering
	\includegraphics[width=0.55\linewidth]{\figdir/Central-Peripheral}
...
\begin{figure}[!b]
	\centering
	\includegraphics[width=0.9\linewidth]{\figdir/ble_mqtt}
